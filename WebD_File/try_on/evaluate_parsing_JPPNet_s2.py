...
from try_on.utils import *
from try_on.LIP_model import *

N_CLASSES = 20
INPUT_SIZE = (384, 384)
DATA_DIRECTORY = r'try_on\custom\test'
DATA_LIST_PATH = r'try_on\custom\test_pairs.txt'
NUM_STEPS = 1 # Number of images in the validation set.
RESTORE_FROM = r'try_on\checkpoint\JPPNet-s2'
OUTPUT_DIR = r'try_on\custom\test\image-parse'
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)
OUTPUT_DIR1 = r'try_on\custom\test\image-parse-new'
