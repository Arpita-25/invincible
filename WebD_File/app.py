...
def storeUploadedFile():
    ...
    # fileTobesaved = request.files['image']
    # fileTobesaved.save(dst='uploads/example.jpg', buffer_size=16384)
    file.save(dst='try_on/custom/test/image/000183_0.jpg', buffer_size=16384)
    # im1 = Image.open(r"uploads/example.jpg")
    # im1.save('try_on/custom/test/image/000183_0.jpg')
    src_dir = "try_on/custom/test/image/000183_0.jpg"
    dst_dir = "uploads/example.jpg"
